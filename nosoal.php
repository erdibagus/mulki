...
<div class='row' id='nomorsoal'>
    ...
    <?php for ($n = 0; $n < $jumsoal; $n++) : ?>
        ...
        ?>
        <a style="min-width:50px;height:50px;border-radius:10px;border:solid black;font-size:medium" class='btn btn-app bg-<?= $color ?>' id='badge<?= $id_soal ?>' onclick="loadsoal(<?= $id_mapel ?>,<?= $id_siswa ?>,<?= $n ?>)"> <?= $nomor ?> <span id='jawabtemp<?= $id_soal ?>' class='badge bg-red' style="font-size:medium"><?php if($jawabannya == "A"): ?>
                                                                                                                                                                                                                                                                                                                                    1
                                                                                                                                                                                                                                                                                                                                    <?php elseif($jawabannya == "B"): ?>
                                                                                                                                                                                                                                                                                                                                    2
                                                                                                                                                                                                                                                                                                                                    <?php elseif($jawabannya == "C"): ?>
                                                                                                                                                                                                                                                                                                                                    3
                                                                                                                                                                                                                                                                                                                                    <?php elseif($jawabannya == "D"): ?>
                                                                                                                                                                                                                                                                                                                                    4
                                                                                                                                                                                                                                                                                                                                    <?php elseif($jawabannya == "E"): ?>
                                                                                                                                                                                                                                                                                                                                    5
                                                                                                                                                                                                                                                                                                                                    <?php endif; ?></span></a>
    <?php endfor; ?>
</div>